...
from PyQt5.QtWidgets import QApplication, QMainWindow, QFileDialog, QMessageBox, QListWidget, QWidget, QLayout

from design_form_new1 import Ui_MainWindow
...
class MyWidget(QMainWindow, Ui_MainWindow):
    ...
    def about(self):
        ...
        self.msgBox.setText(
            ...
            "Берите последовательно по одной точке рисунка, вносите ее координаты в соответствующие окна.\nПосле внесения координат нажмите кнопку проверить, \nчтобы узнать, правильно ли определены координаты.\nКоличество попыток пока не ограничено.")
        self.msgBox.exec()
